...
population_size = [30, 100, 100, 25]
parent_count = [6, 6, 6, 6]
selection_function = [tournament_select_parents, tournament_select_parents, tournament_select_parents, tournament_select_parents]
...
crossover_func = [crossover_function, crossover_function, crossover_function3, crossover_function3]
hillclimbing_probability=[0.0, 0.0, 0.0, 0.00]
crossover_probability=[0.55, 0.55, 0.75, 0.75]
